...
const SuperAdminUsers = () => {
  setSEO("Users | Super Admin", "Manage admins and mentors in the EdTech platform.", "/super-admin/users");
  return (
    <DashboardLayout userRole="Super Admin" userName="Admin User" sidebarContent={<SuperAdminSidebar />}>
      <h1 className="text-2xl font-bold mb-4">Admins & Mentors</h1>
      <p className="text-muted-foreground">Only Super Admin can create Admins and Mentors. (Creation UI coming soon)</p>
    </DashboardLayout>
  );
};
