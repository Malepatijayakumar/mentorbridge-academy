...
const SuperAdminResources = () => {
  setSEO("Resources | Super Admin", "Manage global resources in the EdTech platform.", "/super-admin/resources");
  return (
    <DashboardLayout userRole="Super Admin" userName="Admin User" sidebarContent={<SuperAdminSidebar />}>
      <h1 className="text-2xl font-bold mb-4">Global Resources</h1>
      <p className="text-muted-foreground">Upload and manage resources used across the platform.</p>
    </DashboardLayout>
  );
};
