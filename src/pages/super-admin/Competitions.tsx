...
const SuperAdminCompetitions = () => {
  setSEO("Competitions | Super Admin", "Manage competitions across the platform.", "/super-admin/competitions");
  return (
    <DashboardLayout userRole="Super Admin" userName="Admin User" sidebarContent={<SuperAdminSidebar />}>
      ...
      <p className="text-muted-foreground">Plan and track competitions.</p>
    </DashboardLayout>
  );
};

export default SuperAdminCompetitions;